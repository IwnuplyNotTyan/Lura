...
func SeedData() {
	if Lang == "ru" {
		Vmonsters = []Monster{
			{MonsterType: "Дракон", HP: 130, Damage: 25, Score: 50, Coins: 20, ID: 3},
			{MonsterType: "Орк", HP: 50, Damage: 15, Score: 20, Coins: 7, ID: 4},
			{MonsterType: "Гоблин", HP: 40, Damage: 10, Score: 15, Coins: 5, ID: 5},
			{MonsterType: "Тролль", HP: 70, Damage: 20, Score: 35, Coins: 9, ID: 6},
			{MonsterType: "Воин", HP: 100, Damage: 20, Score: 45, Coins: 15, ID: 7},
			{MonsterType: "Огр", HP: 80, Damage: 20, Score: 40, Coins: 14, ID: 8},
			{MonsterType: "Скелет", HP: 50, Damage: 10, Score: 20, Coins: 6, ID: 9},
			{MonsterType: "Зомби", HP: 60, Damage: 15, Score: 30, Coins: 11, ID: 10},
			{MonsterType: "Мушкетер", HP: 80, Damage: 30, Score: 30, Coins: 10, ID: 1},
		}
		Weapons = []Weapon{
			{WeaponType: "Меч", Damage: 13, Stamina: 10, ID: 1},
			{WeaponType: "Копье", Damage: 12, Stamina: 7, ID: 2},
			{WeaponType: "Топор", Damage: 16, Stamina: 15, ID: 3},
			{WeaponType: "Кинжал", Damage: 11, Stamina: 5, ID: 4},
			{WeaponType: "Лук", Damage: 11, Stamina: 9, ID: 5},
			{WeaponType: "Длинный лук", Damage: 11, Stamina: 9, ID: 6},
		...
		Longsword = []Weapon{
			{WeaponType: "Длинный меч", Damage: 15, Stamina: 13, ID: 9},
		}
		Crossbow = []Weapon{
			{WeaponType: "Арбалет", Damage: 13, Stamina: 11, ID: 10},
		}
		Scmonsters = []Monster{
			{MonsterType: "Кристальный охранник", HP: 100, Damage: 20, Score: 60, Coins: 13, ID: 11},
			{MonsterType: "Голем", HP: 130, Damage: 10, Score: 60, Coins: 17, ID: 12},
			{MonsterType: "Шахтер", HP: 60, Damage: 20, Score: 20, Coins: 14, ID: 13},
			{MonsterType: "Эфитный Титан", HP: 100, Damage: 20, Score: 70, Coins: 14},
		//	{MonsterType: "Lanter keeper", HP: 70, Damage: 10, score: 10, coins: 14, ID: 2},
			{MonsterType: "Призрак", HP: 40, Damage: 5, Score: 4, Coins: 10, ID: 15},
		}
		Boss = []Monster{
